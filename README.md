...
- Auth and Notifications: Firebase (https://firebase.google.com)
- Database: MySQL (Google Cloud SQL for MySQL)
- AI: Gemini API
- ORM: Prisma
- Deployment: Vercel (app) + Google Cloud (MySQL)

## Backend Scope (MVP)

- Gemini prompt-based legal risk analysis for Moroccan context
- Role-based auth (client, advocate)
- Contract analysis storage in MySQL
...
6. Reservation request form saved in MySQL

## Step-by-Step Execution Plan (6 Hours)

1. Setup (45 min)
Create Next.js app, install Firebase SDK, Prisma, MySQL client, and Gemini SDK.

2. Auth (45 min)
Configure Firebase project, enable Email/Password auth, implement login/register.

3. Database (45 min)
Create MySQL database, define Prisma models: users, analyses, advocates, reservations, messages.

4. Contract Analysis (75 min)
Build Contract Analysis page, call Gemini API, return structured risks with severity and short reason.
...
Add profile and chat history basics, legal disclaimer, test full flow, deploy.
