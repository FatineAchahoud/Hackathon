...
```json
{
  "message": "Can you review this payment clause?",
  "advocateName": "Legal AI Assistant",
  "advocateSpecialty": "Moroccan contract guidance",
  "reservationSummary": "General consultation",
  "language": "en",
  "conversationHistory": [
...
{
  "ok": true,
  "reply": "Here is a concise legal response..."
}
```
...
3. Optional: set `ALLOWED_ORIGINS` as a comma-separated list for CORS, for example `http://localhost:8000` when serving the frontend with the local HTTP server.
